    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>SUR Events Management</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a  party, post-work gathering, celebratory function, conference, business
                meeting, wedding or private dining event, our dedicated SUR Events team can create a package that will meet
                your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
